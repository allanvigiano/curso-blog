...
<modal-component modal-name="add" title="Adicionar">
    ...
    <form-component css-class="" action="{{route('users.store')}}" method="post" enctype="" token="{{csrf_token()}}" form-id="formAdd"> 
...
<modal-component modal-name="edit" title="Editar">
    ...
    <form-component css-class="" :action="'/admin/users/' + $store.state.item.id" method="put" enctype="teste" token="{{csrf_token()}}" form-id="formEdit"> 
        <div class="form-group">
            <label for="nome">Nome</label>
